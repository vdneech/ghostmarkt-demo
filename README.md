...
Демо-версия бэкенд-сервера интернет-магазинаghostmarkt.com. Документация по API и openapi-схема доступны соответственно по поддоменам docs.ghostmarkt.com и api.ghostmarkt.com.
